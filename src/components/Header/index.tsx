...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-9999 flex w-full bg-blue-500 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4">
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke  p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark "
          >
          ...
          <Link className="block flex-shrink-0 lg:hidden" href="/">
            <h2 className='text-2xl text-white font-bold'>APRIDEV</h2>
          </Link>
        </div>
        <div className="flex  gap-3 2xsm:gap-7 ml-auto">
          <DropdownUser />
        </div>
      </div>
    </header>
